...
The second style is preferred. Applying the BDD style to unit tests means we tend to be testing the _functionality_ rather than the _implementation_. It means we can change the implementation of something, and its tests should continue to pass.
